...
(function (d) {
    ...
    l.prototype = {
      ...
      /*  createContent: function() {
            var items=["cover",1,2,3,4,5,6,7,"last_cover"];
                                 items.forEach(function(item){
                                    if (item == "cover"){
                                       $("#pageContent").load("./pages/cover.html");
                                    }
                                    if (item == "last_cover"){
                                       $("#pageContent").load("./pages/last_cover.html");
                                    }
                                    else if (item != "cover" && item != "last_cover"){
                                       pageNr = "page" + item;
                                       var divPg = document.createElement('div');
                                       divPg.setAttribute('id', pageNr);
                                       divFeature.appendChild(divPg);
                                       $("#"+divPg.id).load("./pages/"+divPg.id+".html");
                                    }
                                 })
        },*/
        ...
        toggleControl: function (a, b) { (a = this.opts.controls[a]) && d(a).toggleClass("wowbook-disabled", b)
        }
    };
    d.wowBook.defaults = {
        width: 500,
